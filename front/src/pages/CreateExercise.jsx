...
import { createExercise } from "../data/teacherEndpoint";
...
export default function CreateExercise() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setInstructions("");
      setTimeLimit(15);
      setQuestions([{ id: 1, text: "", options: ["", "", "", ""], correct: null }]);
      setValidationError("");
      ...
      <header className="flex flex-col gap-6 border-b border-zinc-100 pb-10 dark:border-zinc-800 md:flex-row md:items-end md:justify-between">
        <div className="space-y-3">
          ...
          <p className="font-medium italic text-zinc-500 dark:text-zinc-400">
            Build a targeted exercise and send it to the right grade.
          </p>
        </div>
        ...
        {success && (
          <div className="flex items-center gap-3 rounded-2xl bg-emerald-500 px-6 py-3 text-white shadow-xl">
            ...
            <span className="text-sm font-bold">Exercise published successfully</span>
          </div>
        )}
      </header>
